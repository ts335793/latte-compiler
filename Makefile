...
dist/build/LatteCompiler/LatteCompiler: src/Main.hs src/SemanticAnalysis.hs src/BNFC/AbsLatte.hs src/BNFC/ErrM.hs src/BNFC/LexLatte.hs src/BNFC/ParLatte.hs src/BNFC/PrintLatte.hs src/BNFC/SkelLatte.hs
	cabal build
